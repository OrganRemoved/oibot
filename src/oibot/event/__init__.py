...
from typing import Any, Callable, ClassVar, Self, TypedDict

from oibot.bot import OP, OiBot
...
class Event:
    ...
    def __init_subclass__(cls, *args, **kwargs) -> None:
        logging.debug(f"registered {cls} as type {cls.event_type}")

        Event.event[cls.event_type] = cls

    def __getattr__(self, name: str) -> Any:
        try:
            return self.ctx["d"][name]
    ...
    async def __aenter__(self) -> Self:
        self.dependency_cache: dict[Callable[..., Any], Any] = {}
